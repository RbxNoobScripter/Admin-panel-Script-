...
local function CreateSupportGui()
    ...
    LaterButton.InputEnded:Connect(function(input)
...
.new("TextBox")
                ...
                BackgroundFrame.Size = UDim2.new(0.4, 0, 0.8, 0)
                ...
                MainFrame.Parent = ScreenGui
                MainFrame.Size = UDim2.new(0.37, 0, 0.75, 0)
                    ...
                    if spawnObjectsEnabled then
                        ...
                        local spawnObject = function()
                            if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                                ...
                                local objectType = objectTypes[facts.random(1, #objectTypes)]
                                local newObject
